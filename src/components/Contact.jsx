  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#1e1e1e] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/438225d2-a80d-4c93-bc73-65d7ec20c825" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-[#bbb4ab] text-gray-300'>Contact</p>
            ...
            <button className='text-white border-2 hover:bg-[#bbb4ab] hover:border-[#bbb4ab] px-4 py-3 my-8 mx-auto flex items-center'>Let's Connect</button>
        </form>
